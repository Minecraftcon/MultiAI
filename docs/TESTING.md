...
| `client/src/components/chat-ui.js` | Tool badge creation, status updates, output formatting, collapse state | (Pending Phase 1 UI safety net) | Rendering DOM integration |
...
- [ ] `client/src/components/chat-ui.js` badge generation & icon mapping (Criticality: High, Priority: P0)
