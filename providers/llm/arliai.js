...
class ArliAIProvider extends BaseProvider {
    ...
    parseResponse(data) {
        ...
        // ArliAI returns reasoning in message.reasoning or message.reasoning_content
        let reasoning = rawMessage.reasoning || rawMessage.reasoning_content || "";
        ...
        // Format reasoning / thinking steps (e.g. Qwen3.5-27B-Derestricted)
